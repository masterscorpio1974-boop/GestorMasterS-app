...
MDScreen:
    ...
    MDBoxLayout:
        ...
        MDBoxLayout:
            ...
            Image:
                source: "icon.png"  # Cambiado para usar tu icon.png existente como logo superior
                size_hint: None, None
                size: "90dp", "90dp"
                pos_hint: {"center_x": .5}
                ...
                MDScrollView:
                    MDBoxLayout:
                        ...
                        MDRaisedButton:
                            ...
                            pos_hint: {"center_x": .5}
                            md_bg_color: 0, 0.5, 0.9, 1  # Azul Crystal
...
class GestorMasterS(MDApp):
    ...
    def guardar_cliente(self):
        ...
        if nom and tel:
            # Lógica de almacenamiento puro en formato Markdown (.md)
